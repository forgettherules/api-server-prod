...
exports.searchController = exports.searchHelper = void 0;
...
async function searchHelper(jobId, req, team_id, subscription_id, crawlerOptions, pageOptions, searchOptions, plan) {
    ...
    const { scrapeOptions, internalOptions } = (0, types_2.fromLegacyCombo)(pageOptions, undefined, 60000, crawlerOptions);
    if (justSearch) {
    ...
    res = res.filter((r) => !(0, blocklist_1.isUrlBlocked)(r.url));
    ...
    const jobPriority = await (0, job_priority_1.getJobPriority)({ plan, team_id, basePriority: 20 });
...
async function searchController(req, res) {
    try {
        ...
        const result = await searchHelper(jobId, req, team_id, chunk?.sub_id, crawlerOptions, pageOptions, searchOptions, plan);
