...
exports.autoscalerController = exports.queuesController = exports.checkQueuesController = exports.cleanBefore24hCompleteJobsController = void 0;
...
async function cleanBefore24hCompleteJobsController(req, res) {
    ...
    try {
        ...
        const before24hJobs = completedJobs.filter((job) => job.finishedOn !== undefined && job.finishedOn < Date.now() - 24 * 60 * 60 * 1000) || [];
        let count = 0;
        if (!before24hJobs) {
